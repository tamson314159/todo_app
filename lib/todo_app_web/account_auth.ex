defmodule TodoAppWeb.AccountAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_todo_app_web_account_remember_me"
  ...
  the current_account:
      ...
      defmodule TodoAppWeb.PageLive do
        ...
        on_mount {TodoAppWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TodoAppWeb.AccountAuth, :ensure_authenticated}] do
