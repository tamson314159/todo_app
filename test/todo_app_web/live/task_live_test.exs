defmodule TodoAppWeb.TaskLiveTest do
  ...
  @create_attrs %{completed: true, date: "2023-07-31", title: "some title"}
  @update_attrs %{completed: false, date: "2023-08-01", title: "some updated title"}
  @invalid_attrs %{completed: false, date: nil, title: nil}
